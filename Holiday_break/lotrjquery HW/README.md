...
1. First fork, then clone this repository
2. You will be writing your answers inside the `app.js` file located in the folder from this repo: `lotr_homework/js/app.js`
3. Open the `index.html` file in your browser to test your work. It is located at: `lotr_homework/index.html`
