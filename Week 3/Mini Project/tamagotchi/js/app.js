...
function render(){
	...
	document.querySelector("div h1").textContent = petObject.getName();
}
...
function renderContinously(){
	...
	if(age===4 && age<8){
		image.src = "images/cats/1monthCat.jpeg";
		if(animationCount === 0){
		...
		image.src = "images/cats/2monthCat.jpg";
		if(animationCount === 0){
			addAnimation("transition.perspectiveUpIn");
			animationCount++;
		}
		...
		image.src = "images/cats/1yearCat.png";
		if(animationCount === 0){
			addAnimation("transition.perspectiveUpIn");
			animationCount++;
		}
		...
		image.src = "images/cats/oldCat.jpeg";
		if(animationCount === 0){
			addAnimation("transition.perspectiveUpIn");
			animationCount++;
		}
	...
	if(petObject.getHunger() >= 10 || petObject.getSleepiness() >= 10 || petObject.getBoredom() >= 10){
		catAlive = false;
		image.src = "images/cats/deadCat.jpg";
		if(animationCount == 0){
